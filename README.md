...
* Year-based format to facilitate analysis across time and filtering by range of years
* Main scripts:
    * parse PTC to TDC
...
* Original info: [[2021-01-05 Downloading PubTatorCentral (PTC) data]]
...
* Original info: [[2021-02-09 attempt python bioc]]
...
* Original info: [[2021-02-26 Tests PTC to TDC]] and [[2021-03-08 PTC to TDC: jobs timed out from 2009]].
** note that the dir was renamed to `kd-data-tools`.
...
Note that some jobs (recent years) will require more than 2 days computation (see [[2021-03-08 PTC to TDC: jobs timed out from 2009]]).
...
Original info: [[2021-02-26 TDC = Tabular Doc-Concept format (aka KD format)]]
...
** In PTC a concept identifier can contain pretty much any character, including the comma `,` and even the separator `@` (at least one case, see [[2021-03-17 Problem separator PTC to TDC]]).
...
Original info: [[2021-03-24 Wrapping up PTC TDC data]]
...
Original info: [[2021-03-11 roadmap for collecting indiv and pair data with python]]
